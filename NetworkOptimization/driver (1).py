...
# MAGIC %pip install -U -qqqq mlflow<3 langchain langgraph==0.3.4 databricks-langchain pydantic databricks-agents unitycatalog-langchain[databricks] uv
...
# MAGIC         tool_description="Respond to the user's question by searching the device manual."
# MAGIC     )
# MAGIC ]
...
# schema = ""
# model_name = ""
UC_MODEL_NAME = f"{CATALOG}.{SCHEMA}.shn_triage_model"
