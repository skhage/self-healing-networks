...
vector_search_index_tools = [
    VectorSearchRetrieverTool(
        index_name="telco_demos.self_healing_networks.device_manuals_chunked_docs_vs",
        # TODO: specify index description for better agent tool selection
        tool_description="Respond to the user's question by searching the device manual."
    )
]
